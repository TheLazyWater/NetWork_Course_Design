...
QT_MOC_LITERAL(3, 14, 11), // "DataPackage"
QT_MOC_LITERAL(4, 26, 4) // "data"

    },
    "Capture\0send\0\0DataPackage\0data"
};
...
void Capture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send((*reinterpret_cast< DataPackage(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Capture::*)(DataPackage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Capture::send)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Capture::send(DataPackage _t1)
{
